...
exports.CustomerModule = CustomerModule = __decorate([
    (0, common_1.Module)({
        ...
        exports: [customer_service_1.CustomerService, mongoose_1.MongooseModule.forFeature([{ name: customer_schema_1.Customer.name, schema: customer_schema_1.CustomerSchema }]),],
    })
], CustomerModule);
